<?php 
    ...
    require('./lib/festivals_action.php');
    require('./lib/convertMonth.php');
    require('./common/top.php');
    require('./common/bottom.php');
    Top('Festivals', './assets/css/sortfestival.css');
                ...
                <div class="row">
                    <div class="col-lg-9">
                        ...
                        <div class="row fes-suggest">
                            ...
                            <div class="col-lg-4">
                                <a href="/posts-festival.php?id=<?php echo $row_festivals['id']?>">
                                    <img class="img-fluid" 
                            ...
                            <div class="col-lg-8">
                                <div class="blog-festival">
                                    <h4>
                                        <a href="/posts-festival.php?id=<?php echo $row_festivals['id']?>" class="hoverable">
                                    ...
                                    <a name="button" id="blue-button" class="btn btn-primary btn-festival"
                                        href="/posts-festival.php?id=<?php echo $row_festivals['id']?>" role="button">Read more
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="row festival-news">
                            <div class="col-4" style='text-align: center'>
                                <a href="/posts-festival.php?id=<?php echo $row_festivalNew['id']?>"><img class="img-fluid img-festival-news"
                                    src="<?php echo $row_festivalNew['avata_festival']?>">
                                </a>
                            </div>
                            <div class="col-8">
                                <a href="/posts-festival.php?id=<?php echo $row_festivalNew['id']?>" class="sidebar-text">
